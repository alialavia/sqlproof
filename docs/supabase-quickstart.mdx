...
<Steps>
  ...
  <Step title="Point SqlProof at your database">
  ...
  <Step title="Drop in `AGENTS.md` at the project root">
  ...
  <Step title="Make sure Supabase is running, then ask your agent for a test">
    ```bash
    supabase start
    ```
  ...
  <Step title="Run before every `supabase db push`">
