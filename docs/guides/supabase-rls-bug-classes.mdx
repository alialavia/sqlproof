...
<Accordion title="Every public table has RLS enabled">
...
<Accordion title="Every policy specifies a TO clause">
...
<Accordion title="Every SECURITY DEFINER function pins search_path">
